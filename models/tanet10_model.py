"""
python train.py --dataroot ./datasets/Vid4 --name Vid4_tanet10 --model tanet10 --display_freq  40  --print_freq  4 --imgseqlen 5  --num_threads 2
...
from . import tanet10_networks
from util import remove_pad_for_tensor


class TANET10Model(BaseModel):
    """ This class implements the tanet10 model
    ...
    def __init__(self, opt):
        ...
        self.netG = tanet10_networks.define_G(opt)
